...
from util_func import get_dataset, prep_adapt_dataset, prep_mnist_adapt_dataset
...
csv_filename = f"mnist_dataset_experiment_results_{timestamp}.csv"
...
for idx, model_class in enumerate(models):
    for axx_mult in approx_mults:
        for FR in fault_rates:
            ...
            set_random_seeds()
            data_t, trainset_1 = prep_mnist_adapt_dataset()
