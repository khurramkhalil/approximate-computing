...
def mobilenet_sdn_v1(pretrained=False, path=False, progress=True, device="cpu", axx_mult = 'mul8s_1L2N', dataset_name="CIFAR10", **kwargs):
    ...
    return _mobilenet("mobilenet_sdn_v1", pretrained, progress, device, dataset_name, **kwargs)
